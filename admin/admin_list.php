...
<html lang="zh-tw">
  <head>
    <meta charset="utf-8">
    <title>物品管理 | CCU CSIE Property</title>
  ...
  <div class="container" >
    ...
    <section id="query-list">
      ...
      <div class="row">
        <div class="pull-left">
          <a class="offset1 btn btn-primary" href="admin_add_item.php">新增物品</a>
        </div>
        ...
        for ($i=0; $i < count( $properties )-1; $i++) { 
          echo "
            <tr"; if($properties[$i]['p_state'] == 2) echo " class=\"warning\""; elseif($properties[$i]['p_state'] == 3) echo " class=\"error\""; echo ">
              <td data-title=\"編號\" name=\"p_id\">".$properties[$i]['p_id']."</td>
          ...
          echo "<td data-title=\"執行\"><div class=\"btn-group\"><a data-toggle=\"modal\" href=\"modal_property_detail.php?id=".$properties[$i]['p_id']."\" data-target=\"#infor\" role=\"button\" class=\"btn\">詳細資訊</a><a class=\"btn\" href=\"admin_edit_item.php?p_id=".$properties[$i]['p_id']."\">編輯</a></div></td>";
        }
?>
        </tbody>
      </table>
