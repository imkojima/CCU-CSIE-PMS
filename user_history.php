            ...
            if (count($reserves) <= 1) {
              ...
              for ($i=0; $i < count( $reserves )-1; $i++) { 
                ...
                echo "
                    ...
                    <td data-title=\"執行\"><div class=\"btn-group\"><button class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#detail\" href=\"modal_reserve_detail.php?r_id=".$reserves[$i]['r_id']."\">詳細資料</button><button class=\"btn\" data-toggle=\"modal\" data-target=\"#cancel_reserve\" href=\"reserve_cancel.php?r_id=".$reserves[$i]['r_id']."&page=history\""; if ($reserves[$i]['r_state'] > '1') echo "disabled"; echo " 
                    >取消預約</a></div></td>
                  </tr>
                ";
              }
